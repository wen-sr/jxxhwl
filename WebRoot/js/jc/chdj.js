...
function addInfo(){
	...
	var jiaobao = $("#jiaobao").textbox("getValue");
	...
	$.ajax({
		...
		data:'dd=' + dd + '&lingPiaoZong=' + lingPiaoZong + '&yunShuZong=' + yunShuZong + '&yunShuDang=' + yunShuDang + '&weiDao=' + weiDao + '&daBao=' + daBao + '&tieBao=' + tieBao+ '&jiaoCan=' + jiaoCan + '&wenJiao=' + wenJiao + '&nanChangShi=' + nanChangShi+ '&daiFa=' + daiFa + '&heJi=' + heJi + '&tui=' + tui + '&addwho=' + addwho + '&note=' + note + '&issue=' + issue + '&jiaobao=' + jiaobao ,
		dataType:'json',
...
function editInfo(){
	...
	var jiaobao = $("#edit_jiaobao").textbox("getValue");
	var reg = new RegExp("^[0-9]*$");
	if('' == dd) {
		$.messager.alert("操作提示","日期不能为空！","error");
		return;
	...
	$.ajax({
		...
		data:'dd=' + dd + '&lingPiaoZong=' + lingPiaoZong + '&yunShuZong=' + yunShuZong + '&yunShuDang=' + yunShuDang + '&weiDao=' + weiDao + '&daBao=' + daBao + '&tieBao=' + tieBao+ '&jiaoCan=' + jiaoCan + '&wenJiao=' + wenJiao + '&nanChangShi=' + nanChangShi+ '&daiFa=' + daiFa + '&heJi=' + heJi + '&tui=' + tui + '&addwho=' + addwho + '&id=' + id + '&note=' + note + '&issue=' + issue + '&jiaobao=' + jiaobao,
		dataType:'json',
		success : function (data){
			$("#data").datagrid('reload');
...
function enterKey(){
	...
	$("#tui").textbox('textbox').bind('keydown',function(event){
		if(event.keyCode == "13"){
			$('#jiaobao').textbox('textbox').focus();
		}
	});
	$("#jiaobao").textbox('textbox').bind('keydown',function(event){
		if(event.keyCode == "13"){
